...
class NuscDataset(BaseMapDataset):
    ...
    def __init__(self, data_root, **kwargs):
        ...
        self.map_extractor.global_map_config = self.global_map_config
        self.map_extractor.init_global_args()
    ...
    def get_sample(self, idx):
        ...
        map_geoms, global_id_dict = self.map_extractor.get_map_geom(location, sample['e2g_translation'], 
                sample['e2g_rotation'])
        ...
        map_label2global_id = {}
        for k, v in global_id_dict.items():
            if k in self.cat2id.keys():
                map_label2global_id[self.cat2id[k]] = v
        ...
        input_dict = {
            ...
            'global_ids': map_label2global_id, # {0: List[str], 1: ...}
