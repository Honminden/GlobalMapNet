...
class GlobalMapNetTransformerDecoder(BaseModule):
    ...
    def forward(self,
        ...
        for lid, layer in enumerate(self.layers):
            # query propagation, banned if streaming_cfg not set
...
class GlobalMapNetTransformerLayer(BaseTransformerLayer):
...
class GlobalMapNetTransformer(Transformer):
