...
eval_config = dict(
    type='AV2Dataset',
    ann_file=ANN_ROOT + 'av2_map_infos_val_newsplit.pkl',
    meta=meta,
    roi_size=roi_size,
    cat2id=cat2id,
    pipeline=[
...
data = dict(
    ...
    train=dict(
        type='AV2Dataset',
        ann_file=ANN_ROOT + 'av2_map_infos_train_newsplit.pkl',
        meta=meta,
        roi_size=roi_size,
        cat2id=cat2id,
...
custom_hooks = [
    dict(type='GlobalMapHook', interval=num_iters_per_epoch, eval_interval=eval_interval, start_keep_global_map_iter=num_iters_single_frame)
]
