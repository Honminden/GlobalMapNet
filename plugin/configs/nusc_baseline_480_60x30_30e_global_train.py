...
lr_config = dict(
    ...
    warmup_ratio=1.0 / 3,
    min_lr_ratio=3e-3)
eval_interval = num_epochs//6*num_iters_per_epoch
...
custom_hooks = [
    dict(type='GlobalMapHook', interval=num_iters_per_epoch, eval_interval=eval_interval, start_keep_global_map_iter=num_epochs//6*num_iters_per_epoch)
]
